...
use App\Http\Services\ClientCredentialsGrantServices;

class ClientCredentialsGrantController extends Controller
{
     ...
     */
    public function __construct(Request $request, ClientCredentialsGrantServices $services)
    {
